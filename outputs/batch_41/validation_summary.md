...
| Total Validation Errors | 526 |
| Total Validation Warnings | 817 |
...
| Subtotals sum to grand total | 4 failures |

## Top Issues

| Code | Count | Description |
|------|-------|-------------|
| `ROW_FROM_NON_SOI_PAGE` | 606 | See detailed report |
| `CITATION_VALUE_MISMATCH` | 498 | See detailed report |
| `BBOX_PAGE_OUT_OF_RANGE` | 104 | See detailed report |
| `BBOX_OUT_OF_RANGE` | 59 | See detailed report |
| `POSSIBLE_DUPLICATE_HOLDINGS` | 10 | See detailed report |
| `FUND_MISSING_TOTAL` | 7 | See detailed report |
| `DATE_MISMATCH` | 7 | See detailed report |
| `TOTAL_PATH_MISMATCH` | 6 | See detailed report |
| `NORMALIZATION_APPLIED` | 6 | See detailed report |
| `ARITH_MISMATCH_PCT` | 6 | Percent sum doesn't match subtotal |
