...
| Total Validation Errors | 615 |
| Total Validation Warnings | 647 |
...
|------|-------|-------------|
| `CITATION_VALUE_MISMATCH` | 585 | See detailed report |
| `ROW_FROM_NON_SOI_PAGE` | 465 | See detailed report |
| `BBOX_PAGE_OUT_OF_RANGE` | 127 | See detailed report |
| `MISSING_SUBTOTAL` | 19 | See detailed report |
| `BBOX_OUT_OF_RANGE` | 13 | See detailed report |
| `DATE_MISMATCH` | 9 | See detailed report |
| `NORMALIZATION_APPLIED` | 8 | See detailed report |
| `ARITH_MISMATCH_PCT` | 7 | Percent sum doesn't match subtotal |
